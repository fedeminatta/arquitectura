...
import 'kleur/colors';
import { $ as $$Layout } from '../chunks/properties_CZs4fJj0.mjs';
...
</h1> <p class="text-lg md:text-xl text-gray-700 leading-relaxed whitespace-pre-line" data-astro-cid-akaj74l7> ${description} </p> </header> <section class="py-10" data-astro-cid-akaj74l7> ${renderComponent($$result2, "PropertyList", PropertyList, { "client:visible": true, "slice": false, "client:component-hydration": "visible", "client:component-path": "@components/PropertyList/PropertyList", "client:component-export": "default", "data-astro-cid-akaj74l7": true })} </section> ` })} `;
