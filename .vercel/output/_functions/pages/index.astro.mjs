...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Inmobiliaria Demo", "data-astro-cid-s2p4isyu": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HeroSection", $$HeroSection, { "data-astro-cid-s2p4isyu": true })} ${maybeRenderHead()}<section class="py-12 px-4" data-astro-cid-s2p4isyu> <h2 class="text-4xl font-extrabold text-center text-gray-800 mb-10" data-astro-cid-s2p4isyu>Propiedades Destacadas</h2> ${renderComponent($$result2, "PropertyList", PropertyList, { "client:visible": true, "slice": true, "client:component-hydration": "visible", "client:component-path": "@components/PropertyList/PropertyList", "client:component-export": "default", "data-astro-cid-s2p4isyu": true })} <div class="text-center mt-8" data-astro-cid-s2p4isyu> <a href="/properties" class="inline-block bg-pink-600 hover:bg-pink-700 text-white font-bold py-3 px-6 rounded-full transition duration-300 ease-in-out shadow-lg" data-astro-cid-s2p4isyu>
Ver Todas las Propiedades
</a> </div> </section> ${renderComponent($$result2, "SectionInfo", SectionInfo, { "client:visible": true, "bgColor": "#FBD9DB", "img": img1, "title": "Nuestros Servicios", "description": "Ofrecemos una gama completa de servicios inmobiliarios, desde la compra y venta de propiedades residenciales y comerciales hasta el alquiler y la gesti\xF3n de propiedades. Nuestro equipo de expertos te guiar\xE1 en cada paso del proceso, asegurando una experiencia fluida y exitosa.", "client:component-hydration": "visible", "client:component-path": "@components/SectionInfo/SectionInfo", "client:component-export": "default", "data-astro-cid-s2p4isyu": true })} ${renderComponent($$result2, "SectionInfo", SectionInfo, { "client:visible": true, "bgColor": "#bce19f", "right": true, "img": img2, "title": "Proceso Simplificado", "description": "Simplificamos el proceso de compra o venta de tu propiedad. Desde la valoraci\xF3n inicial hasta la firma final, te proporcionamos asesoramiento experto, marketing efectivo y negociaci\xF3n profesional para asegurar los mejores resultados. Tu tranquilidad es nuestra prioridad.", "client:component-hydration": "visible", "client:component-path": "@components/SectionInfo/SectionInfo", "client:component-export": "default", "data-astro-cid-s2p4isyu": true })} ${renderComponent($$result2, "SectionInfo", SectionInfo, { "client:visible": true, "bgColor": "#ffd088", "img": img3, "title": "Por Qu\xE9 Elegirnos", "description": "Nos destacamos por nuestra atenci\xF3n personalizada, conocimiento profundo del mercado local y un compromiso inquebrantable con la satisfacci\xF3n del cliente. Te ofrecemos soluciones a medida, transparencia total y un equipo dedicado a hacer realidad tus sue\xF1os inmobiliarios. Conf\xEDa en nosotros para tu pr\xF3xima inversi\xF3n.", "client:component-hydration": "visible", "client:component-path": "@components/SectionInfo/SectionInfo", "client:component-export": "default", "data-astro-cid-s2p4isyu": true })} ${renderComponent($$result2, "Nosotros", $$Nosotros, { "data-astro-cid-s2p4isyu": true })} ${renderComponent($$result2, "CallToAction", $$CallToAction, { "data-astro-cid-s2p4isyu": true })} ${renderComponent($$result2, "Nav", $$Nav, { "data-astro-cid-s2p4isyu": true })} ${renderComponent($$result2, "Footer", $$Footer, { "data-astro-cid-s2p4isyu": true })} ` })} `;
